...
public class FitLifeGUI extends JFrame {
    ...
    private static final Color colorR3 = new Color(180, 230, 180);  // Verde claro suave para intensidad media
    ...
    class FondoBienvenida extends JPanel {
        ...
        public FondoBienvenida() {
            ...
            try {
                String imagePath = "assets/inicio.jpg";
                imagenFondo = new ImageIcon(imagePath).getImage();
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    private JPanel crearPanelBienvenida() {
        // Usar nuestro panel personalizado con fondo
        JPanel panel = new FondoBienvenida();
        ...
        subtitulo.setBorder(BorderFactory.createEmptyBorder(100, 0, 10, 0));
        ...
        centerPanel.setOpaque(false); // Hacer el panel transparente para ver el fondo
